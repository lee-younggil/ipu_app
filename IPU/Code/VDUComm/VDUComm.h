...
typedef enum _CU_LINK_STATE
{
	CU_VEHICLE_STATE_NONE				= 0x00,
	CU_VEHICLE_STATE_TRIGGER_NO			= 0x01,
	CU_VEHICLE_STATE_IMAGE		        = 0x02,
	CU_VEHICLE_STATE_IMAGE_RESP     	= 0x04
} CU_VEHICLE_STATE;

class CVDUComm : public QObject
{
    Q_OBJECT
public:
    CVDUComm();
    ...
    void TestTriggerNum(unsigned short usSeqNo);
...
private:
    ...
    void decodeTriggerNum(unsigned char* pucaBuf);
